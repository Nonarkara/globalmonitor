        ...
        <div className="bottom-card" style={{ padding: '10px 12px' }}>
            ...
            >
                <div style={{ display: 'flex', gap: '4px', marginBottom: '8px' }}>
                    <KPI icon={Users} label="Fatalities" value={formatNumber(totalFatalities)} color="var(--red)" sub="confirmed" />
                    <KPI icon={Users} label="Displaced" value={formatNumber(displacedCount)} color="var(--ink)" sub="estimated" />
