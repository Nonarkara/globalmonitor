...
const EventDetailsPanel = ({ event, onClose }) => {
    ...
    return (
        <div className="grid-panel" style={{ padding: '24px', position: 'relative' }}>
            <button className="details-close-btn" onClick={onClose} aria-label="Close details" style={{ position: 'absolute', top: '16px', right: '16px', background: '#f2f0ea', border: 'none', color: 'var(--ink-2)', width: '32px', height: '32px', borderRadius: '50%', cursor: 'pointer' }}>
                <X size={18} />
            </button>
