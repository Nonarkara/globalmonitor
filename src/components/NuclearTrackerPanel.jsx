    ...
    return (
        <div className="bottom-card" style={{ padding: '10px 12px' }}>
            ...
            <div style={{
                ...
                <div>
                    <div style={{ fontSize: '0.5rem', color: 'var(--ink-2)', letterSpacing: '0.5px', textTransform: 'uppercase', marginBottom: '2px' }}>
                        Breakout Estimate
                    </div>
                    <div style={{ display: 'flex', gap: '12px' }}>
                        <div>
                            ...
                            <span style={{ fontSize: '0.5rem', color: 'var(--ink-3)', marginLeft: '4px' }}>post-war</span>
                        </div>
                        <div>
                            ...
                            <span style={{ fontSize: '0.5rem', color: 'var(--ink-3)', marginLeft: '4px' }}>pre-war</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '4px', marginBottom: '8px' }}>
                {[
                    ...
                    <div key={k.label} style={{
                        ...
                        <div style={{ fontSize: '0.5rem', color: 'var(--ink-3)', letterSpacing: '0.5px', textTransform: 'uppercase' }}>{k.label}</div>
                    </div>
                ))}
            </div>
